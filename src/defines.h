...
/* -KN- each x-th level is an entrance to a new part of Angband; */
/*		stairs won't be generated by no other means than entering */
/*		the QUEST VAULT and descending further */
#define XTH_VAULT        4
